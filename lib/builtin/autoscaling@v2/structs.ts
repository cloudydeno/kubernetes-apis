// Autogenerated Schema file for AutoscalingV2
...
export function toHorizontalPodAutoscaler(input: c.JSONValue): HorizontalPodAutoscaler & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "autoscaling/v2", "HorizontalPodAutoscaler"),
...
export function fromHorizontalPodAutoscaler(input: HorizontalPodAutoscaler): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "autoscaling/v2", "HorizontalPodAutoscaler"),
    ...input,
...
export interface HorizontalPodAutoscalerStatus {
  conditions?: Array<HorizontalPodAutoscalerCondition> | null;
...
export function toHorizontalPodAutoscalerStatus(input: c.JSONValue): HorizontalPodAutoscalerStatus {
  const obj = c.checkObj(input);
  return {
    conditions: c.readOpt(obj["conditions"], x => c.readList(x, toHorizontalPodAutoscalerCondition)),
...
export function toHorizontalPodAutoscalerList(input: c.JSONValue): HorizontalPodAutoscalerList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "autoscaling/v2", "HorizontalPodAutoscalerList"),
