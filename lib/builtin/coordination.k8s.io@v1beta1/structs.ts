...
export function toLeaseCandidate(input: c.JSONValue): LeaseCandidate & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "coordination.k8s.io/v1beta1", "LeaseCandidate"),
...
export function fromLeaseCandidate(input: LeaseCandidate): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "coordination.k8s.io/v1beta1", "LeaseCandidate"),
    ...input,
...
export function toLeaseCandidateList(input: c.JSONValue): LeaseCandidateList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "coordination.k8s.io/v1beta1", "LeaseCandidateList"),
